...
class PikaClient:
    def __init__(self, process_callable):
        ...
        self.publish_queue_name = 'movie_publish_queue'
    ...
    async def consume(self, loop):
        ...
        cast_queue = await channel.declare_queue('cast_publish_queue')
        await cast_queue.consume(self.process_incoming_message, no_ack=False)
